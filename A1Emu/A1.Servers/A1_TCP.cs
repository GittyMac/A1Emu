...
namespace A1Emu.A1.Servers
{
            ...
            foreach (string command in commands)
            {
                ...
                switch (commandInfo[0])
                {
                    ...
                    case "cs":
                        ...
                        break;
                    case "er":
                        responses.Add(EndRound(command, commandInfo[1], commandInfo[2], commandInfo[3], commandInfo[4], commandInfo[5], commandInfo[6]));
                        break;
                    case "ba":
                        responses.Add(SendXMLPacket(command, "6"));
                        break;
    ...
    class ServerSystem : TcpServer
    {
        ...
        protected override TcpSession CreateSession() { return new A1_TCP(this, serverPort, sqServer, serverDirectory); }
